...
#define STRING_CONFIG_H_AUTHOR "(Perk, Ender-3-SKR-Mini-E3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  19.55,  19.55 }
    #define DEFAULT_Ki_LIST {   1.28,   1.28 }
    #define DEFAULT_Kd_LIST {  74.87,  74.87 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95.876 }
